...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                </h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ تعديل مأكولات</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
        ...
        @endif
        {{--   page content    --}}
        <form action="{{ route('items.update',$item->id) }}" method="post" autocomplete="off"
                                        ...
                                        @foreach($item->itemTypes as $itemType)
                                            ...
                                            <div class="repeater-item">
                                                <input class="col-4" type="text" name="options[]"
                                                       placeholder="إسم الصنف" required="" value="{{ $itemType->name }}">
                                                <input class="col-4" type="number" name="prices[]"
                                                       placeholder="سعر الصنف" required="" value="{{ $itemType->price }}">
